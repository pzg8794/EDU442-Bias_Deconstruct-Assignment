...
Analytically, I treated these artifacts as a small qualitative data set rather than as anecdotes. I reread each transcript line by line, marking where adults named students, invoked or resisted deficit labels, and shifted participation structures. I also coded my own talk and journal entries for moments where I narrated students as ``problems'' or as capable co-learners. This recursive reading helped me connect individual quotes to broader patterns that DisCrit, linguistic justice, and funds-of-knowledge frameworks make visible (Annamma et al., 2013; Gonzalez et al., 2005; Paris \& Alim, 2014).
...
DisCrit also pushes me to see these dynamics as structurally produced, not just interpersonal. The same interpretive habits that show up in my notes underwrite disproportionate referrals of Black and Brown neurodivergent students to special education and exclusionary discipline (Annamma et al., 2013; Nieto, 2004). Naming that link keeps this analysis accountable to material consequences of bias, not just to my feelings about fairness.
...
Second, I want to lead with relationship and co-regulation. In \EvidenceSet{1} and \EvidenceSet{3}, purposeful roles, patience, and competence-talk supported re-entry into learning; those moves are part of instruction, not optional extras. Thoughtfully connecting with this group means building predictable routines, checking in on how noise and pace land in their bodies, and noticing who is consistently positioned on the margins of talk so that I can redesign the task. It also means being honest about my own limits and triggers so that students are not asked to manage my nervous system for me (\JournalArtifact{2}).
...
For my future work settings beyond this practicum, that means approaching new classrooms with the same questions: whose brilliance is being misread as disruption, how are language and disability discourses shaping that reading, and what concrete routines can I design so that fewer students are positioned as ``problems'' in the first place? It also means engaging with colleagues and families as partners in this work so that the responsibility for deconstructing bias is shared rather than individual.
